...
export default class PaymentGatewayControllerComp extends LightningElement {
    image = myResource;      
    ...
    //         payByAuthrizePayment({cardNumber : this.cardNumber, expireMonth : this.cardMonth, expireYear: this.cardYear, amount :'50', cvv : this.cvv
    //         }).then(result =>{
